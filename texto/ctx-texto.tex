  ...
  \startchapter[title=Texto]
    ...
    \startsection[title=Función generadora \color[red]{\type{textext}}]
      ...
      \startsubsection[title={Comandos de \ConTeXt\ en el texto}]
        ...
        \stopMPcode
        Desde luego, se podría dibujar un marco en \MetaPost, pero \type{framed}
        de \ConTeXt tiene más opciones, como alineaciones.

      \stopsubsection

    \stopsection
    
    \startsection[title=Función generadora \color[red]{\type{lmt_text}}]

      Podemos incluir texto utilizando la interfaz de \MetaFun, que utiliza los
      atributos, \type{text}, \type{color}, \type{style}, ... etc., separados por
      comas, en las opciones de la función:
      \starttyping[option=METAFUN]
        \startMPcode
      ...
      Cuando se escriben números, podemos usar la opción \type{format}:
      \starttyping[option=METAFUN]
        \startMPcode
          fill fullcircle xyscaled (8cm,1cm) withcolor "darkred" ;
          draw lmt_text [
...
%      \startMPcode
%        fill fullcircle xyscaled (8cm,1cm) withcolor "black" ;
%        draw lmt_text [
%          text
%          = "Número" decimal 123.45678,
%          color = "white",
%          style = "bold",
%          format = "@0.3F",
%        ] ;

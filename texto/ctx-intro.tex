...
\startcomponent ctx-intro
  ...
  \startsection[title=Función generadora \color[red]{\type{fullcircle}}]
    ...
    \startsubsection[title={Operadores secundarios \color[darkgreen]{\type{xscaled}},
      ...
      Si no queremos escalar el objeto gráfico (\type{picture}) de forma uniforme,
      tenemos las siguientes tres opciones. La primera que vamos a ver escala
      la dimensión horizontal, pero deja sin modificar la vertical:

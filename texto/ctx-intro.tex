...
\startcomponent ctx-intro
  ...
  \startsection[title=Función generadora \color[red]{\type{fullcircle}}]
    ...
    \startsubsection[title={Operadores secundarios \color[darkgreen]{\type{xscaled}},
      ...
      X e Y de forma independiente.

      Por tanto, si no queremos escalar el objeto gráfico (\type{picture}) de forma
      uniforme, tenemos las siguientes opciones:

      \startitemize[packed,joinedup]
      \item Escalar la dimensión horizontal sin modificar la vertical:
      ...
      \item Escalar la dimensión vertical sin modificar la horizontal:
    ...
    \item Modificar las dos dimensiones a la vez.
      En realidad, esta es una macro que combina las dos anteriores, solo que lo
      hace más rápido.
      Los dos valores de escalado se deben situar entre paréntesis y separados por
      una coma:
